...
c_id <- c(1:89331)
client$clientnumber <- paste(client$firstname, client$surname, sep="_")
client$clientnumber <- paste(client$clientnumber, c_id, sep="_")
# Edit data driver
library(dplyr)
c_id <- c(1:9994)
#rename the columns
...
driver$drivernumber <- paste(driver$firstname, driver$surname, sep="_")
driver$drivernumber <- paste(driver$drivernumber, c_id, sep="_")
